...
<body>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="password" name="password" id="password-input" class="form-control" placeholder="Minimal 8 karakter" required style="padding-right: 48px;">
    ...
    <!-- Register Loader -->
    <div id="register-loader" style="display: none; position: fixed; inset: 0; background: rgba(255,255,255,0.85); backdrop-filter: blur(8px); z-index: 99999; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.2s ease;">
        <div style="position: relative; width: 120px; height: 120px; display: flex; align-items: center; justify-content: center; transform: scale(0.9); transition: transform 0.2s ease;" id="register-loader-content">
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function() {
            ...
            document.getElementById('register-loader-content').style.transform = 'scale(1)';
        });
